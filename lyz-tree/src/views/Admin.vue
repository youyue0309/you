  ...
  <div id="admin">
    ...
    <el-row class="main">
      <el-col class="main-left" :span="5">
        <el-menu default-active="2" class="el-menu-vertical-demo" background-color="#f8f8f8">
          <el-menu-item @click="$router.push('/admin/user')" index="1">
          ...
          <el-submenu index="2">
            ...
            <el-submenu index="2-2">
              ...
              <el-menu-item index="2-2-1">商品查看</el-menu-item>
              <el-menu-item index="2-2-2">商品添加</el-menu-item>
            </el-submenu>
          </el-submenu>
          <el-submenu index="3">
            <template slot="title">
