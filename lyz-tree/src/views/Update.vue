...
export default {
    ...
    return {
      ...
      rules: {
        ...
        type: [
          ...
          { min: 1, max: 2, message: "1-8", trigger: "blur" }
        ],
        high: [
  ...
  created(){
      ...
      this.ruleForm.city = this.$route.query.res.city;
      this.ruleForm.high = this.$route.query.res.high;
      this.ruleForm.r = this.$route.query.res.r;
